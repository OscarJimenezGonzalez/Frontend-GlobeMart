...
export default function purchasePolicy() {
    ...
    return (
        <Typography> Returns: Customers can return products within 30 days of receipt if in original condition for a full refund. Initiate returns through your account under 'My Orders'.
